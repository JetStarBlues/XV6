...
void preempt ( void )
{
	...
	if ( pid3 == 0 )
	{
		...
		{
			printf( stdout, "preempt write error" );
		}
...
void createdelete ( void )
{
	...
	printf( stdout, "createdelete test\n" );
...
void fourteen ( void )
{
	...
	if ( fd < 0 )
	{
		printf( stdout, "create 123456789012345/123456789012345/123456789012345 failed\n" );
...
void iref ( void )
{
	...
	printf( stdout, "empty file name OK\n" );
}
